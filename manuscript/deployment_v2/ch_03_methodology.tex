...
We interviewed practitioners with hands-on experience deploying ML systems to achieve our objective. A summary of the ML systems, 
...
\begin{itemize}
    ...
    \item RQ2) What recurrent themes emerge in deployment workflows of ML models? %patterns => recurrent themes => share characteristics
...
% \begin{figure}[h]
% \centering
% \includegraphics[width=\linewidth]{deployment_highlevel_framework}
% \caption{A high-level view of ML post-development activities}
% \label{fig:deployment_highlevel_framework}
% \end{figure}
