...
\DIFdelbegin \DIFdel{We conducted an }\DIFdelend \DIFaddbegin \DIFadd{An }\DIFaddend exploratory multiple-case study \cite{Runeson2008} \DIFaddbegin \DIFadd{was conducted }\DIFaddend between March and August 2021. \DIFaddbegin \DIFadd{The research approach was selected to gain a deep understanding of the enacted practices and tool support for ML systems in real-world settings.
}\DIFaddend %The research data was primarily collected through semi-structured interviews ~\cite{myers2007qualitative, Runeson2008}. 
